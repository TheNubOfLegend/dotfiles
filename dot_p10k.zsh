# Generated by Powerlevel10k configuration wizard on 2024-05-19 at 21:49 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#D08770'
  ...
  # ~/*.config*/nvim/
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#4c566a'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#5e81ac'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#81a1c1'
